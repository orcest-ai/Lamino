...
# - manager user can list/create/update/delete teams, update team member/workspace assignments, read team detail/member/workspace/access-map surfaces, read usage monitoring + usage policy/effective endpoints, create/update/delete usage policies, and read system preferences
