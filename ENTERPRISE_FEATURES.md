...
# - default user denied prompt template admin reads/writes (`/admin/prompt-templates`, `/admin/prompt-templates/new`, `/admin/prompt-templates/:templateId` update/delete)
...
# - manager user can list/create/update/delete teams, update team member/workspace assignments, read team detail/member/workspace/access-map surfaces, read usage monitoring + usage policy/effective endpoints, create/update/delete usage policies, create/update/delete prompt templates, and read system preferences
