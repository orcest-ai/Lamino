...
# - default user denied usage monitoring and usage policy admin reads/writes (`/admin/usage/overview`, `/admin/usage/timeseries`, `/admin/usage/breakdown`, `/admin/usage/export.csv`, `/admin/usage-policies`, `/admin/usage-policies/effective`, `/admin/usage-policies/new`)
...
# - manager user can list/create/update/delete teams, update team member/workspace assignments, read team detail/member/workspace/access-map surfaces, read usage monitoring + usage policy/effective endpoints, create/delete usage policies, and read system preferences
