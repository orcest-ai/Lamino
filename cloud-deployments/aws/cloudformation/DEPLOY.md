...
5. Use the file `cloudformation_create_lamino.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_lamino  Created 
 ⠿ Container lamino       Started  
```
