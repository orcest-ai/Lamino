  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "Lamino | Ignite Your AI Layer Symphony",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://lamino.orcest.ai" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://lamino.orcest.ai" },
      },
      {
        tag: "meta",
        props: {
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            content:
              customTitle ??
              "Lamino | Ignite Your AI Layer Symphony",
          };
        }
        // Override meta title
