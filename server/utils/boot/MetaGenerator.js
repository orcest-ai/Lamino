  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "Lamino | Your personal LLM trained on anything",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://lamino.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://lamino.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            content:
              customTitle ??
              "Lamino | Your personal LLM trained on anything",
          };
        }
        // Override meta title
