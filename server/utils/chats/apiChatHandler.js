 ...
 * the mime type for documents is `application/lamino-document` - anything else is assumed to be an image.
...
async function processDocumentAttachments(attachments = []) {
  ...
  for (const attachment of attachments) {
    if (
      ...
      attachment.mime &&
      attachment.mime.toLowerCase() === "application/lamino-document"
    )
