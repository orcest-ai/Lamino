...
class NativeEmbeddingReranker {
  ...
  // This is a folder that Orcest AI hosts for those who cannot capture the HF model download
  // endpoint for various reasons. This endpoint is not guaranteed to be active or maintained
  // and may go offline at any time at Orcest AI's discretion.
  #fallbackHost = "https://cdn.lamino.com/support/models/";
  ...
  async initClient() {
    ...
    NativeEmbeddingReranker.#initializationPromise = (async () => {
      try {
        ...
        // 3. Download and cache from fallback host (cdn.lamino.com)
