      ...
      content: {
        "application/json": {
          example: {
            ...
            deletes: ["custom-documents/lamino.txt-hash.json"]
          }
        }
      }
    }
           ...
           example: {
             ...
             attachments: [
               ...
               },
               {
                 ...
                 mime: "application/lamino-document",
       ...
       "application/json": {
         schema: {
           ...
           example: {
              ...
              sources: [{title: "lamino.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM,"}],
              close: true,
   ...
   */
      try {
        ...
        await Telemetry.sendTelemetry("sent_chat", {
          LLMSelection:
            workspace.chatProvider ?? process.env.LLM_PROVIDER ?? "rainymodel",
          Embedder: process.env.EMBEDDING_ENGINE || "inherit",
          VectorDbSelection: process.env.VECTOR_DB || "lancedb",
          TTSSelection: process.env.TTS_PROVIDER || "native",
        });
           ...
           example: [
            ...
            },
            {
            ...
            },
             {
              ...
              sources: [{title: "lamino.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM. This will only return in the final chunk."}],
              close: true,
              error: "null | text string of the failure mode."
            }
          ]
