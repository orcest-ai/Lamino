...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to Lamino to be parsed and prepared for embedding, with optional metadata.'
    #swagger.requestBody = {
        ...
        "application/json": {
          schema: {
            ...
            example: {
              ...
              documents: [
                {
                  "location": "custom-documents/lamino.txt-6e8be64c-c162-4b43-9997-b068c0071e8b.json",
                  "name": "lamino.txt-6e8be64c-c162-4b43-9997-b068c0071e8b.json",
                  "url": "file:///Users/tim/Documents/lamino/collector/hotdir/lamino.txt",
                  "title": "lamino.txt",
                  "docAuthor": "Unknown",
                  "description": "Unknown",
                  "docSource": "a text file uploaded by the user.",
                  "chunkSource": "lamino.txt",
  ...
  app.post(
    ...
    async (request, response) => {
      /*
      #swagger.tags = ['Documents']
      #swagger.description = 'Upload a new file to a specific folder in Lamino to be parsed and prepared for embedding. If the folder does not exist, it will be created.'
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for Lamino to scrape and prepare for embedding. Optionally, specify a comma-separated list of workspace slugs to embed the document into post-upload.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "chunkSource": "https:lamino.com.html",
                  "published": "1/16/2024, 3:46:33 PM",
                  "wordCount": 252,
                  "pageContent": "Lamino is the best....",
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in Lamino.",
              "addToWorkspaces": "workspace1,workspace2",
              "metadata": {
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique Lamino document name'
