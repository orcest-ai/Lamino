...
<p align="center">
    <b>Lamino：</b> 您一直在寻找的全方位AI应用程序。<br />
...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的Lamino！<a href="https://lamino.orcest.ai/download" target="_blank">立即下载</a>
</p>
...
Lamino是一个全栈应用程序，您可以使用现成的商业大语言模型或流行的开源大语言模型，再结合向量数据库解决方案构建一个私有ChatGPT，不再受制于人：您可以本地运行，也可以远程托管，并能够与您提供的任何文档智能聊天。

Lamino将您的文档划分为称为`workspaces` (工作区)的对象。工作区的功能类似于线程，同时增加了文档的容器化。工作区可以共享文档，但工作区之间的内容不会互相干扰或污染，因此您可以保持每个工作区的上下文清晰。

## Lamino的一些酷炫特性

- 🆕 [**完全兼容 MCP**](https://docs.lamino.orcest.ai/mcp-compatibility/overview)
- 🆕 [**无代码AI代理构建器**](https://docs.lamino.orcest.ai/agent-flows/overview)
...
- [Novita AI (聊天模型)](https://novita.ai/model-api/product/llm-api?utm_source=github_lamino&utm_medium=github_readme&utm_campaign=link)
- [PPIO (聊天模型)](https://ppinfra.com?utm_source=github_lamino)
...
- [Lamino原生嵌入器](/server/storage/models/README.md)（默认）
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
Orcest.ai和社区维护了许多部署方法、脚本和模板，您可以使用它们在本地运行Lamino。请参阅下面的表格，了解如何在您喜欢的环境上部署，或自动部署。
...
[其他方案：不使用Docker配置Lamino实例 →](../BARE_METAL.md)
...
_以下是一些与 Lamino 兼容的应用程序，但并非由 Orcest.ai 维护。列在此处并不代表官方背书。_

- [Midori AI 子系统管理器 - 使用 Docker 容器技术高效部署 AI 系统的简化方式](https://io.midori-ai.xyz/subsystem/lamino/) - 使用 Docker 容器技术高效部署 AI 系统的简化方式。
- [Coolify](https://coolify.io/docs/services/lamino/) - 一键部署 Lamino。
- [适用于 Microsoft Word 的 GPTLocalhost](https://gptlocalhost.com/demo/) - 一个本地 Word 插件，让你可以在 Microsoft Word 中使用 Lamino。

## 远程信息收集与隐私保护

由 Orcest.ai 开发的 Lamino 包含一个收集匿名使用信息的 Telemetry 功能。

<details>
<summary><kbd>有关 Lamino 的远程信息收集与隐私保护更多信息</kbd></summary>

### 为什么收集信息？

我们使用这些信息来帮助我们理解 Lamino 的使用情况，帮助我们确定新功能和错误修复的优先级，并帮助我们提高 Lamino 的性能和稳定性。
...
[在源代码中查看所有信息收集活动](https://github.com/search?q=repo%3AOrcest-ai%2Flamino%20.sendTelemetry(&type=code)
