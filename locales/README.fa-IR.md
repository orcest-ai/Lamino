...
<p align="center" dir="rtl">
    <b>Lamino:</b> اپلیکیشن همه‌کاره هوش مصنوعی که دنبالش بودید.<br />
...
<p align="center" dir="rtl">
👈 Lamino برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://lamino.orcest.ai/download" target="_blank">دانلود کنید</a>
</p>
...
Lamino یک اپلیکیشن کامل است که در آن می‌توانید از LLM‌های تجاری آماده یا LLM‌های متن‌باز محبوب و راه‌حل‌های vectorDB برای ساخت یک ChatGPT خصوصی بدون محدودیت استفاده کنید که می‌توانید آن را به صورت محلی اجرا کنید یا از راه دور میزبانی کنید و با هر سندی که به آن ارائه می‌دهید، هوشمندانه گفتگو کنید.

Lamino اسناد شما را به اشیایی به نام `workspaces` تقسیم می‌کند. یک Workspace مانند یک رشته عمل می‌کند، اما با اضافه شدن کانتینرسازی اسناد شما. Workspaceها می‌توانند اسناد را به اشتراک بگذارند، اما با یکدیگر ارتباط برقرار نمی‌کنند تا بتوانید زمینه هر workspace را تمیز نگه دارید.

</div>
<div dir="rtl">

## ویژگی‌های جذاب Lamino

- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.lamino.orcest.ai/agent/custom/introduction)
...
- [Lamino Native Embedder](/server/storage/models/README.md) (پیش‌فرض)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [Lamino Built-in](https://github.com/danialsamiei/llm.orcest.ai/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/danialsamiei/llm.orcest.ai-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/danialsamiei/llm.orcest.ai-extension).
...
Orcest.ai و جامعه کاربران، روش‌ها، اسکریپت‌ها و قالب‌های متعددی را برای اجرای Lamino به صورت محلی نگهداری می‌کنند. برای مطالعه نحوه استقرار در محیط مورد نظر خود یا استقرار خودکار، به جدول زیر مراجعه کنید.
...
[یا راه‌اندازی نمونه تولیدی Lamino بدون Docker →](../BARE_METAL.md)
...
Lamino توسط Orcest.ai دارای ویژگی تله‌متری است که اطلاعات استفاده ناشناس را جمع‌آوری می‌کند.

<details>
<summary><kbd>اطلاعات بیشتر درباره تله‌متری و حریم خصوصی Lamino</kbd></summary>

### چرا؟

<div dir="rtl">
ما از این اطلاعات برای درک نحوه استفاده از Lamino، اولویت‌بندی کار روی ویژگی‌های جدید و رفع اشکالات، و بهبود عملکرد و پایداری Lamino استفاده می‌کنیم.
</div>
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3AOrcest-ai%2Flamino%20.sendTelemetry(&type=code)
...
[![مشارکت‌کنندگان lamino](https://contrib.rocks/image?repo=orcest-ai/lamino)](https://github.com/danialsamiei/llm.orcest.ai/graphs/contributors)

[![نمودار تاریخچه ستاره‌ها](https://api.star-history.com/svg?repos=orcest-ai/lamino&type=Timeline)](https://star-history.com/#orcest-ai/lamino&Date)
...
Copyright © 2025 [Orcest.ai][profile-link]. <br />
