...
<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="Orcest-ai%2Flamino | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<p align="center">
<b>Lamino:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
  ...
  <a href="https://docs.lamino.orcest.ai" target="_blank">
   ...
   <a href="https://lamino.orcest.ai" target="_blank">
    Hosted Instance
  </a>
</p>
...
<p align="center">
👉 Masaüstü için Lamino (Mac, Windows ve Linux)! <a href="https://lamino.orcest.ai/download" target="_blank"> Şimdi İndir</a>
</p>
...
![Mesajlaşma](https://github.com/danialsamiei/llm.orcest.ai/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/danialsamiei/llm.orcest.ai-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_
...
- [Novita AI (chat models)](https://novita.ai/model-api/product/llm-api?utm_source=github_lamino&utm_medium=github_readme&utm_campaign=link)
- [PPIO](https://ppinfra.com?utm_source=github_lamino)
...
- **`embed`**: [Web gömme widget’ı](https://github.com/danialsamiei/llm.orcest.ai-embed) oluşturma ve entegrasyonu için alt modül.
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/danialsamiei/llm.orcest.ai-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma

Orcest.ai ve topluluk, Lamino'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında Lamino kurun →](../BARE_METAL.md)
...
_Bu uygulamalar Orcest.ai tarafından yönetilmemektedir, ancak Lamino ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/lamino/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.
- [Coolify](https://coolify.io/docs/services/lamino/) - Tek tıklamayla Lamino dağıtımı yapmanıza olanak tanır.
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - Lamino’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik

Orcest.ai. tarafından geliştirilen Lamino, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.

<details>
<summary><kbd>Lamino için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>

### Neden?

Bu bilgileri, Lamino’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AOrcest-ai%2Flamino%20.sendTelemetry(&type=code)
...
Telif Hakkı © 2025 [Orcest.ai][profile-link]. <br />
Bu proje [MIT](../LICENSE) lisansı ile lisanslanmıştır.

<!-- LINK GROUP -->

[back-to-top]: https://img.shields.io/badge/-BACK_TO_TOP-222628?style=flat-square
[profile-link]: https://github.com/orcest-ai
[vector-admin]: https://github.com/orcest-ai/vector-admin
[assistant-swarm]: https://github.com/Orcest-ai/openai-assistant-swarm
...
[elestio-deploy]: https://elest.io/open-source/lamino
