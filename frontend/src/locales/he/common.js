...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Lamino יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט.",
    },
    userSetup: {
      title: "הגדרת משתמש",
    ...
    survey: {
      title: "ברוכים הבאים ל-Lamino",
      description:
        "עזרו לנו לבנות את Lamino כך שיתאים לצרכים שלכם. אופציונלי.",
      email: "מה האימייל שלך?",
      useCase: "לאיזו מטרה תשתמש ב-Lamino?",
      useCaseWork: "לעבודה",
      useCasePersonal: "לשימוש אישי",
      useCaseOther: "אחר",
      comment: "איך שמעת על Lamino?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "צור את סביבת העבודה הראשונה שלך והתחל לעבוד עם Lamino.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "אתה בדרך להפוך למומחה Lamino!",
      dismiss: "סגור",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "הגדר את העדפות ממשק המשתמש שלך עבור Lamino.",
    },
    branding: {
      title: "מיתוג והתאמה אישית (Whitelabeling)",
      description: "התאם אישית את מופע ה-Lamino שלך עם מיתוג מותאם אישית.",
    },
    chat: {
      title: "צ'אט",
      description: "הגדר את העדפות הצ'אט שלך עבור Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "שפת תצוגה",
        description:
          "בחר את השפה המועדפת להצגת ממשק המשתמש של Lamino - כאשר תרגומים זמינים.",
      },
      logo: {
        title: "לוגו מותג",
      ...
      "welcome-messages": {
        ...
        user: "משתמש",
        message: "הודעה",
        assistant: "עוזר הצ'אט של Lamino",
  ...
  api: {
    title: "מפתחות API",
    description:
      "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע Lamino זה.",
  ...
  llm: {
    title: "העדפות מודל שפה (LLM)",
    description:
      "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת Lamino לא יפעל כראוי.",
    provider: "ספק LLM",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "ספק תמלול",
    "warn-start":
      "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של Lamino בעת עיבוד קובצי מדיה.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-Lamino יכול להשתמש בו לעיבוד.",
    provider: {
      title: "ספק הטמעה",
    },
  },
  ...
  vector: {
    ...
    description:
      "אלה האישורים וההגדרות לאופן פעולת מופע ה-Lamino שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-Lamino מטפלים בנתונים שלך.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של Lamino. קבצים אלה אינם נשלחים או משותפים עם צד שלישי.",
    },
    pinning: {
      what_pinning: "מהי הצמדת מסמכים?",
      pin_explained_block1:
        "כאשר אתה <b>מצמיד</b> מסמך ב-Lamino, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      pin_explained_block2:
        "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      pin_explained_block3:
        "אם אינך מקבל את התשובות הרצויות מ-Lamino כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      accept: "אוקיי, הבנתי",
    },
    watching: {
      what_watching: "מה עושה מעקב אחר מסמך?",
      watch_explained_block1:
        "כאשר אתה <b>עוקב</b> אחר מסמך ב-Lamino, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "נדרש אימות",
          description:
            "עליך להתאמת עם מרכז הקהילה של Lamino לפני פרסום פריטים.",
  ...
  security: {
    ...
    password: {
      title: "הגנת סיסמה",
      description:
        "הגן על מופע ה-Lamino שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
