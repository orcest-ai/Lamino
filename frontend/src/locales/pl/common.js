...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Lamino może współpracować z wieloma dostawcami modeli językowych",
    },
    userSetup: {
    ...
    survey: {
      title: "Witamy w Lamino",
      description:
        "Pomóż nam stworzyć Lamino dostosowany do Twoich potrzeb. Opcjonalnie.",
      email: "Jaki jest Twój adres e-mail?",
      useCase: "Do czego będziesz używać Lamino?",
      useCaseWork: "Do pracy",
      useCasePersonal: "Do użytku osobistego",
      useCaseOther: "Inne",
      comment: "Skąd dowiedziałeś się o Lamino?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Stwórz swój pierwszy obszar roboczy i zacznij korzystać z Lamino.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "Jesteś na najlepszej drodze do zostania ekspertem Lamino!",
      dismiss: "zamknij",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Ustaw preferencje interfejsu użytkownika dla Lamino.",
    },
    branding: {
      title: "Branding i white-labeling",
      description:
        "Oznakuj swoją instancję Lamino niestandardowym brandingiem.",
    },
    chat: {
      title: "Czat",
      description: "Ustaw preferencje czatu dla Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Język",
        description:
          "Wybierz preferowany język interfejsu użytkownika Lamino - jeśli dostępne są tłumaczenia.",
      },
      logo: {
        title: "Logo",
        description:
      ...
      "welcome-messages": {
        ...
        user: "użytkownika",
        message: "wiadomość",
        assistant: "Asystent czatu Lamino",
  ...
  api: {
    title: "Klucze API",
    description:
      "Klucze API umożliwiają dostęp do instancji Lamino i zarządzanie nią.",
  ...
  llm: {
    ...
    description:
      "Tutaj skonfigurujesz dostawcę modeli językowych używanych do czatów i embeddingów. Upewnij się, że wszystkie klucze są aktualne i poprawne - bez tego Lamino nie będzie działać.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korzystanie z lokalnego modelu Whisper na komputerach z ograniczoną pamięcią RAM lub procesorem może spowodować przerwanie pracy Lamino podczas przetwarzania plików multimedialnych.",
    "warn-recommend":
  ...
  vector: {
    ...
    description:
      "Tutaj skonfigurujesz wektorową bazę danych dla Lamino. Upewnij się, że wszystkie ustawienia są poprawne.",
    provider: {
      title: "Wektorowa baza danych",
  ...
  privacy: {
    ...
    description:
      "Jest to konfiguracja sposobu, w jaki połączeni dostawcy zewnętrzni i Lamino przetwarzają dane użytkownika.",
    llm: "Wybór LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Pliki zostaną przetworzone w obrębie danej instancji Lamino. Pliki te nie będą udostępniane innym podmiotom.",
    },
    pinning: {
      what_pinning: "Czym jest przypinanie dokumentów?",
      pin_explained_block1:
        "Kiedy <b>przypinasz</b> dokument w Lamino, dodamy całą zawartość dokumentu do okna promptu, aby LLM mógł w pełni zrozumieć jego treść.",
      ...
      pin_explained_block3:
        "Jeśli domyślnie nie otrzymujesz pożądanych odpowiedzi z Lamino, przypinanie jest świetnym sposobem na uzyskanie wyższej jakości odpowiedzi za jednym kliknięciem.",
      accept: "Ok, rozumiem",
    },
    watching: {
      what_watching: "Do czego służy oglądanie dokumentu?",
      watch_explained_block1:
        "Podczas <b>obserwowania</b> dokumentu w Lamino będziemy <i>automatycznie</i> synchronizować zawartość dokumentu z jego oryginalnym źródłem w regularnych odstępach czasu. Spowoduje to automatyczną aktualizację zawartości w każdym obszarze roboczym, w którym ten plik jest zarządzany.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Przed opublikowaniem elementów należy uwierzytelnić się w centrum społeczności Lamino.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chroń swoją instancję Lamino hasłem. Jeśli go zapomnisz, nie ma metody odzyskiwania, więc upewnij się, że zapisałeś to hasło.",
