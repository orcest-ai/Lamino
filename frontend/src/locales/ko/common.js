...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 기본 설정",
      description:
        "Lamino은 다양한 LLM 제공자와 연동할 수 있습니다. 여기서 선택한 서비스가 채팅을 담당하게 됩니다.",
    },
    userSetup: {
      title: "사용자 설정",
    ...
    data: {
      ...
      description:
        "Lamino은 여러분의 개인정보에 대한 투명성과 제어권을 최우선으로 생각합니다.",
      settingsHint: "이 설정은 언제든지 설정 메뉴에서 다시 변경할 수 있습니다.",
    },
    survey: {
      title: "Lamino에 오신 것을 환영합니다",
      description:
        "여러분의 필요에 맞는 Lamino을 만들 수 있도록 도와주세요. (선택 사항)",
      email: "이메일을 입력해 주세요",
      useCase: "Lamino을 어떤 용도로 사용하실 예정인가요?",
      useCaseWork: "업무용",
      useCasePersonal: "개인용",
      useCaseOther: "기타",
      comment: "Lamino을 어떻게 알게 되셨나요?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "첫 번째 워크스페이스를 생성하고 Lamino을 시작해보세요.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      title: "시작하기",
      tasksLeft: "남은 작업",
      completed: "이제 곧 Lamino 전문가가 되실 거예요!",
      dismiss: "닫기",
      tasks: {
        create_workspace: {
          title: "워크스페이스 만들기",
  ...
  customization: {
    interface: {
      title: "UI 환경 설정",
      description: "Lamino의 UI 환경을 원하는 대로 설정하세요.",
    },
    branding: {
      title: "브랜딩 및 화이트라벨링",
      description:
        "Lamino 인스턴스에 맞춤 브랜딩을 적용해 화이트라벨링할 수 있습니다.",
    },
    chat: {
      title: "채팅",
      description: "Lamino의 채팅 환경을 원하는 대로 설정하세요.",
      auto_submit: {
        title: "음성 입력 자동 전송",
        description:
    ...
    items: {
      ...
      "display-language": {
        title: "표시 언어",
        description:
          "Lamino의 UI에 사용할 언어를 선택하세요. 번역이 제공되는 경우에만 적용됩니다.",
      },
      logo: {
        title: "브랜드 로고",
  ...
  api: {
    title: "API 키",
    description:
      "API 키는 소유자가 프로그래밍 방식으로 이 Lamino 인스턴스에 액세스하고 관리할 수 있도록 합니다.",
    link: "API 문서 읽기",
    generate: "새 API 키 생성",
    table: {
      key: "API 키",
  ...
  llm: {
    title: "LLM 기본 설정",
    description:
      "이것은 채팅과 임베딩을 하기 위한 선호하는 LLM 제공자의 인증입니다. 이 키가 현재 활성 상태이고 정확해야 Lamino이 제대로 작동합니다.",
    provider: "LLM 제공자",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "텍스트 변환 제공자",
    "warn-start":
      "RAM 또는 CPU 성능이 제한된 머신에서 로컬 위스퍼 모델을 사용하면 미디어 파일을 처리할 때 Lamino이 중단될 수 있습니다.",
  ...
  embedding: {
    ...
    "desc-end":
      "임베딩은 텍스트를 벡터로 변환하는 과정입니다. 파일과 프롬프트를 Lamino이 처리할 수 있는 형식으로 변환하려면 이러한 인증이 필요합니다.",
    provider: {
      title: "임베딩 제공자",
    },
  },
  ...
  vector: {
    title: "벡터 데이터베이스",
    description:
      "이것은 Lamino 인스턴스가 벡터 데이터베이스 사용을 위한 인증 설정입니다. 이 키가 활성 상태이고 정확해야 합니다.",
    provider: {
      title: "벡터 데이터베이스 제공자",
  ...
  privacy: {
    title: "개인정보와 데이터 처리",
    description:
      "연결된 타사 제공자와 Lamino이 데이터를 처리하는 방식을 구성합니다.",
    llm: "LLM 선택",
    embedding: "임베딩 기본 설정",
    vector: "벡터 데이터베이스",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "이 파일들은 이 Lamino 인스턴스에서 실행 중인 문서 처리기로 업로드됩니다. 파일은 제3자에게 전송되거나 공유되지 않습니다.",
    },
    pinning: {
      what_pinning: "문서 고정이란 무엇인가요?",
      pin_explained_block1:
        "Lamino에서 문서를 <b>고정</b>하면 해당 문서의 전체 내용을 프롬프트 창에 삽입하여 LLM이 완전히 이해할 수 있도록 합니다.",
    ...
    watching: {
      ...
      watch_explained_block1:
        "Lamino에서 문서를 <b>감시</b>하면 원본 소스에서 정기적으로 문서 내용을 <i>자동으로</i> 동기화합니다. 이 파일이 관리되는 모든 워크스페이스의 내용이 자동으로 업데이트됩니다.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "인증 필요",
          description:
            "항목을 게시하려면 Lamino 커뮤니티 허브에 인증해야 합니다.",
          button: "커뮤니티 허브에 연결",
        },
      },
    },
  ...
  security: {
    ...
    password: {
      title: "비밀번호 보호",
      description:
        "Lamino 인스턴스를 비밀번호로 보호하십시오. 이 비밀번호를 잊어버리면 복구 방법이 없으므로 반드시 저장하세요.",
