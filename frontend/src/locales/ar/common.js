...
const TRANSLATIONS = {
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "سيتم تحميل هذه الملفات إلى معالج المستندات الذي يعمل على هذه نسخة من Lamino. هذه الملفات لا يتم إرسالها أو مشاركتها مع طرف ثالث.",
    },
    pinning: {
      what_pinning: 'ما هو عمل "تثبيت المستندات"؟',
      pin_explained_block1:
        "عندما تقوم بإرفاق مستند في Lamino، سنقوم بإدخال محتوى المستند بالكامل في نافذة المطالبة الخاصة بـ LLM الخاص بك، وذلك حتى يتمكن LLM من فهم المحتوى بالكامل.",
      pin_explained_block2:
        "يعمل هذا بشكل أفضل مع **نماذج ذات سياق كبير** أو ملفات صغيرة ولكنها ضرورية لأساس المعرفة الخاص بها.",
      pin_explained_block3:
        'إذا لم تحصل على الإجابات التي ترغب بها بشكل افتراضي من Lamino، فإن استخدام ميزة "التثبيت" هو طريقة رائعة للحصول على إجابات ذات جودة أعلى في نقرة واحدة.',
      accept: "حسناً، فهمت.",
    },
    watching: {
      what_watching: "ما الذي يفعله مشاهدة فيلم وثائقي؟",
      watch_explained_block1:
        "عندما **تشاهد** مستندًا في Lamino، سيتم **مزامنة** محتوى المستند تلقائيًا من مصدره الأصلي على فترات منتظمة. وهذا سيؤدي إلى تحديث المحتوى تلقائيًا في كل مساحة عمل حيث يتم إدارة هذا الملف.",
  ...
  customization: {
    interface: {
      ...
      description: "حدد تفضيلات واجهة المستخدم الخاصة بـ Lamino.",
    },
    branding: {
      title: "التسويق بالعلامة التجارية ووضع العلامات التجارية",
      description:
        "قم بتخصيص نسخة Lamino الخاصة بك باستخدام العلامات التجارية الخاصة بك.",
    },
    chat: {
      title: "دردشة",
      description: "حدد تفضيلات الدردشة الخاصة بك لـ Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "حدد اللغة المفضلة لعرض واجهة مستخدم Lamino - عند توفر الترجمات.",
      },
      logo: {
      ...
      "welcome-messages": {
        ...
        message: "رسالة",
        assistant: "مساعد الدردشة من Lamino",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "أنت على طريق أن تصبح خبيرًا في مجال نماذج لغة Lamino!",
      dismiss: "أغلق",
      tasks: {
        create_workspace: {
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "يتطلب التحقق",
          description:
            "يجب عليك التحقق من هويتك مع مركز مجتمع Lamino قبل نشر أي محتوى.",
