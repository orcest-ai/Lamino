...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Lamino puede funcionar con muchos proveedores de LLM. Este será el servicio que gestionará el chat.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bienvenido a Lamino",
      description:
        "Ayúdanos a hacer que Lamino se adapte a tus necesidades. Opcional.",
      email: "¿Cuál es tu correo electrónico?",
      useCase: "¿Para qué usarás Lamino?",
      useCaseWork: "Para el trabajo",
      useCasePersonal: "Para uso personal",
      useCaseOther: "Otro",
      comment: "¿Cómo te enteraste de Lamino?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Crea tu primer espacio de trabajo y comienza a usar Lamino.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "¡Estás en camino de convertirte en un experto en Lamino!",
      dismiss: "cerrar",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description:
        "Establece tus preferencias de la interfaz de usuario para Lamino.",
    },
    branding: {
      title: "Marca y marca blanca",
      description:
        "Personaliza tu instancia de Lamino con tu propia marca.",
    },
    chat: {
      title: "Chat",
      description: "Establece tus preferencias de chat para Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selecciona el idioma preferido para renderizar la interfaz de usuario de Lamino, cuando las traducciones estén disponibles.",
      },
      logo: {
      ...
      "welcome-messages": {
        ...
        user: "usuario",
        message: "mensaje",
        assistant: "Asistente de chat de Lamino",
  ...
  api: {
    title: "Claves de API",
    description:
      "Las claves de API permiten al titular acceder y administrar programáticamente esta instancia de Lamino.",
  ...
  llm: {
    title: "Preferencia de LLM",
    description:
      "Estas son las credenciales y la configuración de tu proveedor preferido de chat e incrustación de LLM. Es importante que estas claves estén actualizadas y sean correctas, de lo contrario, Lamino no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local de Whisper en máquinas con RAM o CPU limitadas puede detener Lamino al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "La incrustación es el proceso de convertir texto en vectores. Estas credenciales son necesarias para convertir tus archivos y prompts en un formato que Lamino pueda usar para procesar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y la configuración de cómo funcionará tu instancia de Lamino. Es importante que estas claves estén actualizadas y sean correctas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración sobre cómo los proveedores de terceros conectados y Lamino manejan tus datos.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Estos archivos se subirán al procesador de documentos que se ejecuta en esta instancia de Lamino. Estos archivos no se envían ni se comparten con terceros.",
    },
    pinning: {
      what_pinning: "¿Qué es fijar documentos?",
      pin_explained_block1:
        "Cuando <b>fijas</b> un documento en Lamino, inyectaremos todo el contenido del documento en tu ventana de prompt para que tu LLM lo comprenda por completo.",
      ...
      pin_explained_block3:
        "Si no obtienes las respuestas que deseas de Lamino por defecto, fijar es una excelente manera de obtener respuestas de mayor calidad con un clic.",
      accept: "Ok, entendido",
    },
    watching: {
      what_watching: "¿Qué hace observar un documento?",
      watch_explained_block1:
        "Cuando <b>observas</b> un documento en Lamino, sincronizaremos <i>automáticamente</i> el contenido de tu documento desde su fuente original a intervalos regulares. Esto actualizará automáticamente el contenido en cada espacio de trabajo donde se gestione este archivo.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Necesitas autenticarte con el Centro de la Comunidad de Lamino antes de publicar elementos.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de Lamino con una contraseña. Si la olvidas, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
