const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Lamino can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      ...
      description: "Help us make Lamino built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use Lamino for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about Lamino?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with Lamino.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming an Lamino expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for Lamino.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your Lamino instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render Lamino's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this Lamino instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else Lamino will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall Lamino when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which Lamino can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your Lamino instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your Lamino instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and Lamino handle your data.",
    llm: "LLM Provider",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this Lamino instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in Lamino we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from Lamino by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in Lamino we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the Lamino Community Hub before publishing items.",
