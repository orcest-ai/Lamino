...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Lamino peut fonctionner avec de nombreux fournisseurs LLM. Ce sera le service qui traitera vos discussions.",
    },
    userSetup: {
    ...
    data: {
      ...
      description:
        "Configurez comment Lamino stocke et traite vos données.",
      settingsHint:
    ...
    workspace: {
      ...
      description:
        "Créez votre premier espace de travail pour commencer à utiliser Lamino.",
    },
  },
  common: {
  ...
  api: {
    title: "Clés API",
    description:
      "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance Lamino.",
  ...
  llm: {
    title: "Préférence LLM",
    description:
      "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon Lamino ne fonctionnera pas correctement.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer Lamino lors du traitement des fichiers multimédias.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que Lamino peut utiliser pour traiter.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Voici les identifiants et les paramètres de fonctionnement de votre instance Lamino. Il est important que ces clés soient actuelles et correctes.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Voici votre configuration pour la gestion des données et des fournisseurs tiers connectés avec Lamino.",
    llm: "Sélection LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ces fichiers seront téléchargés sur cette instance Lamino uniquement.",
    },
    pinning: {
      what_pinning: "Qu'est-ce que l'épinglage de documents ?",
      pin_explained_block1:
        "Lorsque vous épinglez un document, Lamino injectera le contenu intégral du document dans votre fenêtre de prompt comme contexte préalable pour chaque interaction.",
    ...
    watching: {
      ...
      watch_explained_block1:
        "Lorsque vous surveillez un document, Lamino re-synchronisera automatiquement le contenu du document depuis sa source de manière périodique.",
    ...
    checklist: {
      ...
      tasks: {
        ...
        visit_community: {
          ...
          description:
            "Rejoignez la communauté Lamino pour obtenir de l'aide et partager vos expériences.",
          action: "Visiter",
        },
      },
    },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Vous devez vous connecter à votre compte Lamino pour publier sur le Community Hub.",
          button: "Se connecter",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protégez votre instance Lamino avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
