...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Lamino poate funcționa cu mai mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bun venit la Lamino",
      description:
        "Ajută-ne să facem Lamino potrivit pentru nevoile tale. Opțional.",
      email: "Care este adresa ta de email?",
      useCase: "Pentru ce vei folosi Lamino?",
      useCaseWork: "Pentru muncă",
      useCasePersonal: "Pentru uz personal",
      useCaseOther: "Altele",
      comment: "De unde ai aflat despre Lamino?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Creează primul tău spațiu de lucru și începe să folosești Lamino.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Ești pe drumul să devii expert Lamino!",
      dismiss: "închide",
      tasks: {
        create_workspace: {
  ...
  vector: {
    ...
    description:
      "Acestea sunt credențialele și setările pentru modul în care funcționează instanța ta Lamino. Este important să fie corecte și actuale.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Aceasta este configurația ta pentru modul în care furnizorii terți conectați și Lamino gestionează datele tale.",
    llm: "Selecția LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Aceste fișiere vor fi încărcate în procesorul de documente care rulează pe această instanță Lamino. Aceste fișiere nu sunt trimise sau partajate cu o terță parte.",
    },
    pinning: {
      what_pinning: "Ce este fixarea documentelor?",
      pin_explained_block1:
        "Când **fixezi** un document în Lamino, vom injecta întregul conținut al documentului în fereastra de prompt pentru ca LLM-ul tău să-l înțeleagă pe deplin.",
      ...
      pin_explained_block3:
        "Dacă nu obții răspunsurile dorite de la Lamino în mod implicit, atunci fixarea este o modalitate excelentă de a obține răspunsuri de calitate superioară dintr-un clic.",
      accept: "Ok, am înțeles",
    },
    watching: {
      what_watching: "Ce face vizualizarea unui document?",
      watch_explained_block1:
        "Când **urmărești** un document în Lamino, vom sincroniza *automat* conținutul documentului tău din sursa originală la intervale regulate. Acest lucru va actualiza automat conținutul în fiecare spațiu de lucru unde acest fișier este gestionat.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Trebuie să te autentifici cu Lamino Community Hub înainte de a publica elemente.",
  ...
  customization: {
    interface: {
      title: "Preferințe UI",
      description: "Setează preferințele UI pentru Lamino.",
    },
    branding: {
      title: "Branding & White-labeling",
      description:
        "Personalizează-ți instanța Lamino cu branding personalizat.",
    },
    chat: {
      title: "Chat",
      description: "Setează preferințele de chat pentru Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selectează limba preferată pentru a reda interfața Lamino - atunci când traducerile sunt disponibile.",
      },
      logo: {
        title: "Logo brand",
        description:
      ...
      "welcome-messages": {
        ...
        user: "utilizator",
        message: "mesaj",
        assistant: "Asistent Chat Lamino",
  ...
  api: {
    title: "Chei API",
    description:
      "Cheile API permit deținătorului să acceseze și să gestioneze programatic această instanță Lamino.",
  ...
  llm: {
    title: "Preferința LLM",
    description:
      "Acestea sunt credențialele și setările pentru furnizorul tău preferat de chat și embedding LLM. Este important ca aceste chei să fie actuale și corecte, altfel Lamino nu va funcționa corect.",
  ...
  transcription: {
    ...
    "warn-start":
      "Utilizarea modelului local Whisper pe mașini cu RAM sau CPU limitat poate bloca Lamino la procesarea fișierelor media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding-ul este procesul de transformare a textului în vectori. Aceste credențiale sunt necesare pentru a transforma fișierele și prompturile dvs. într-un format pe care Lamino îl poate utiliza pentru procesare.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protejează instanța Lamino cu o parolă. Dacă o uiți, nu există metode de recuperare, deci asigură-te că o salvezi.",
