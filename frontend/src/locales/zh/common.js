...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 偏好",
      description:
        "Lamino 可以与多家 LLM 提供商合作。这将是处理聊天的服务。",
    },
    userSetup: {
      title: "用户设置",
    ...
    survey: {
      title: "欢迎使用 Lamino",
      description: "帮助我们为你的需求打造 Lamino。可选。",
      email: "你的电子邮件是什么？",
      useCase: "你将如何使用 Lamino？",
      useCaseWork: "用于工作",
      useCasePersonal: "用于个人使用",
      useCaseOther: "其他",
      comment: "你是如何听说 Lamino 的？",
      commentPlaceholder:
    ...
    workspace: {
      title: "创建你的第一个工作区",
      description: "创建你的第一个工作区并开始使用 Lamino。",
    },
  },
  common: {
  ...
  customization: {
    interface: {
      title: "界面偏好设置",
      description: "设置您的 Lamino 界面偏好。",
    },
    branding: {
      title: "品牌与白标设置",
      description: "使用自定义品牌对白标您的 Lamino 实例。",
    },
    chat: {
      title: "聊天",
      description: "设置您的 Lamino 聊天偏好。",
      auto_submit: {
        title: "自动提交语音输入",
    ...
    items: {
      ...
      "display-language": {
        title: "显示语言",
        description: "选择显示 Lamino 界面所用的语言（若有翻译可用）。",
      },
      logo: {
        title: "品牌标志",
  ...
  api: {
    title: "API 密钥",
    description: "API 密钥允许持有者以编程方式访问和管理此 Lamino 实例。",
    link: "阅读 API 文档",
  ...
  llm: {
    title: "LLM 首选项",
    description:
      "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，确保这些密钥是最新的和正确的，否则 Lamino 将无法正常运行。",
    provider: "LLM 提供商",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "转录提供商",
    "warn-start":
      "在 RAM 或 CPU 有限的计算机上使用本地耳语模型可能会在处理媒体文件时停止 Lamino。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是将文本转换为矢量的过程。需要这些凭据才能将你的文件和提示转换为 Lamino 可以用来处理的格式。",
    provider: {
      title: "嵌入引擎提供商",
    },
  },
  ...
  vector: {
    title: "向量数据库",
    description:
      "这些是 Lamino 实例如何运行的凭据和设置。重要的是，这些密钥是最新的和正确的。",
    provider: {
      title: "向量数据库提供商",
  ...
  privacy: {
    title: "隐私和数据处理",
    description:
      "这是你对如何处理连接的第三方提供商和Lamino的数据的配置。",
    llm: "LLM 选择",
    embedding: "嵌入首选项",
    vector: "向量数据库",
    anonymous: "启用匿名遥测",
  ...
  connectors: {
    ...
    upload: {
      ...
      "fetch-website": "获取网站",
      "privacy-notice":
        "这些文件将被上传到此 Lamino 实例上的文档处理器。这些文件不会发送或共享给第三方。",
    },
    pinning: {
      what_pinning: "什么是文档固定？",
      pin_explained_block1:
        "当您在 Lamino 中<b>固定</b>一个文档时，我们会将整个文档内容注入到您的提示窗口中，让 LLM 能够完全理解它。",
      pin_explained_block2:
        "这在 <b>大上下文模型</b> 或关键的小文件中效果最佳。",
      pin_explained_block3:
        "如果默认情况下无法从 Lamino 获取满意的答案，固定文档是提高答案质量的好方法。",
      accept: "好的，知道了",
    },
    watching: {
      what_watching: "什么是监控文档？",
      watch_explained_block1:
        "当您在 Lamino 中<b>监控</b>一个文档时，我们会<i>自动</i>按定期间隔从其原始来源同步文档内容。系统会自动更新在所有使用该文档的工作区中的内容。",
  ...
  security: {
    ...
    password: {
      title: "密码保护",
      description:
        "用密码保护你的Lamino实例。如果你忘记了密码，那么没有恢复方法，所以请确保保存这个密码。",
      "password-label": "实例密码",
    },
  },
  home: {
