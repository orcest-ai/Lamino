...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "شما از Lamino برای چه منظوری استفاده خواهید کرد؟",
      useCaseWork: "برای کار",
      useCasePersonal: "برای استفاده شخصی",
      useCaseOther: "سایر",
      comment: "شما از کجا در مورد Lamino مطلع شدید؟",
      commentPlaceholder:
        "Reddit، توییتر، گیت‌هاب، یوتیوب و غیره - لطفاً به ما بگویید که چگونه ما را پیدا کردید!",
      skip: "پرش از نظرسنجی",
      thankYou: "از بازخورد شما سپاسگزاریم.",
      title: "به Lamino خوش آمدید",
      description:
        "ما را در ساخت مدل Lamino متناسب با نیازهای شما یاری دهید. (این بخش اختیاری است)",
    },
    home: {
      title: "به",
    ...
    llm: {
      ...
      description:
        "Lamino می‌تواند با بسیاری از ارائه‌دهندگان مدل‌های زبانی کار کند. این سرویس، مسئولیت انجام مکالمات را بر عهده خواهد داشت.",
    },
    userSetup: {
    ...
    workspace: {
      ...
      description:
        "فضای کاری خود را ایجاد کنید و با Lamino شروع به کار کنید.",
    },
  },
  common: {
  ...
  api: {
    title: "کلیدهای API",
    description:
      "کلیدهای API به دارنده آن‌ها اجازه می‌دهند به صورت برنامه‌نویسی به این نمونه Lamino دسترسی داشته و آن را مدیریت کنند.",
  ...
  llm: {
    ...
    description:
      "این‌ها اعتبارنامه‌ها و تنظیمات ارائه‌دهنده مدل زبانی و جاسازی انتخابی شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند در غیر این صورت Lamino به درستی کار نخواهد کرد.",
  ...
  transcription: {
    ...
    "warn-start":
      "استفاده از مدل محلی Whisper روی دستگاه‌هایی با RAM یا CPU محدود می‌تواند هنگام پردازش فایل‌های رسانه‌ای باعث توقف Lamino شود.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "جاسازی فرآیند تبدیل متن به بردارها است. این اعتبارنامه‌ها برای تبدیل فایل‌ها و درخواست‌های شما به فرمتی که Lamino بتواند پردازش کند، ضروری هستند.",
    provider: {
  ...
  vector: {
    ...
    description:
      "این‌ها اعتبارنامه‌ها و تنظیمات نحوه عملکرد نمونه Lamino شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "این پیکربندی شما برای نحوه مدیریت داده‌ها توسط ارائه‌دهندگان شخص ثالث متصل و Lamino است.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "این فایل‌ها در پردازشگر اسناد که روی این نمونه از Lamino در حال اجرا است، بارگذاری خواهند شد. این فایل‌ها به هیچ شخص ثالثی ارسال یا به اشتراک گذاشته نمی‌شوند.",
    },
    pinning: {
      what_pinning: "مخزن کردن اسناد چیست؟",
      pin_explained_block1:
        'هنگامی که شما یک سند را در Lamino "فیکس" می‌کنید، محتوای کامل سند را در پنجره دستورالعمل برای مدل زبان بزرگ شما قرار می‌دهیم تا مدل بتواند به طور کامل آن را درک کند.',
      ...
      pin_explained_block3:
        "اگر به پاسخ‌های مورد نظر خود از Lamino به طور پیش‌فرض دریافت نمی‌کنید، «پین کردن» یک راه عالی برای دریافت پاسخ‌های با کیفیت بالاتر در یک مرحله است.",
      accept: "باشه، متوجه شدم.",
    },
    watching: {
      what_watching: "تماشای یک مستند چه تاثیری دارد؟",
      watch_explained_block1:
        "هنگام مشاهده یک سند در Lamino، محتوای سند به طور خودکار از منبع اصلی آن، در فواصل زمانی منظم، همگام‌سازی می‌شود. این کار، به‌طور خودکار محتوا را در هر فضای کاری که این فایل در آن مدیریت می‌شود، به‌روز می‌کند.",
  ...
  customization: {
    interface: {
      ...
      description: "تنظیمات رابط کاربری خود را برای Lamino تعیین کنید.",
    },
    branding: {
      title: "برندسازی و ارائه خدمات با برچسب سفید",
      description:
        "با استفاده از برندسازی سفارشی، نمونه‌ی Lamino خود را با برچسب سفید (White-label) ارائه دهید.",
    },
    chat: {
      title: "چت",
      description: "تنظیم ترجیحات چت خود برای Lamino.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "زبان نمایش",
        description:
          "زبان مورد نظر برای نمایش رابط کاربری Lamino را انتخاب کنید - در صورت وجود ترجمه‌ها.",
      },
      logo: {
        title: "لوگوی برند",
        description:
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "شما باید قبل از انتشار مطالب، با مرکز جامعه Lamino احراز هویت کنید.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "از نمونه Lamino خود با رمز عبور محافظت کنید. اگر این رمز را فراموش کنید هیچ روش بازیابی وجود ندارد، پس حتماً این رمز عبور را ذخیره کنید.",
