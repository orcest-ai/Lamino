...
const exportOptions = {
  csv: {
    ...
    fileExtension: "csv",
    filenameFunc: () => {
      return `lamino-embed-chats-${new Date().toLocaleDateString()}`;
    },
  },
  json: {
    name: "JSON",
  ...
  jsonl: {
    ...
    fileExtension: "jsonl",
    filenameFunc: () => {
      return `lamino-embed-chats-${new Date().toLocaleDateString()}-lines`;
    },
  },
  jsonAlpaca: {
    name: "JSON (Alpaca)",
    ...
    fileExtension: "json",
    filenameFunc: () => {
      return `lamino-embed-chats-${new Date().toLocaleDateString()}-alpaca`;
    },
  },
};
