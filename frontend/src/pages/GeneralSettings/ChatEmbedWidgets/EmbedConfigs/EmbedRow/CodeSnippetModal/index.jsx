...
https://github.com/danialsamiei/llm.orcest.ai-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/lamino-chat-widget.min.js">
</script>
<!-- Lamino (https://lamino.orcest.ai) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/danialsamiei/llm.orcest.ai-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
