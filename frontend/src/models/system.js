...
const System = {
  cacheKeys: {
    footerIcons: "lamino_footer_links",
    supportEmail: "lamino_support_email",
    customAppName: "lamino_custom_app_name",
    canViewChatHistory: "lamino_can_view_chat_history",
    deploymentVersion: "lamino_deployment_version",
  },
  ping: async function () {
