...
const LLM_PROVIDER_PRIVACY_MAP = {
  ...
  rainymodel: {
    name: "RainyModel",
    description: [
      "Data is shared according to the terms of service applicable with Orcest AI.",
    ],
    logo: RainyModelLogo,
  },
};
...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Lamino.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "Lamino Embedder",
    description: [
      "Your document text is embedded privately on this instance of Lamino.",
    ],
    logo: LaminoIcon,
  },
  openai: {
