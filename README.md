...
<p align="center">
    <b>Lamino:</b> Layered Advanced Model Integration for Neural Orchestration.<br />
...
<p align="center">
👉 Lamino for desktop (Mac, Windows, & Linux)! <a href="https://lamino.orcest.ai/download" target="_blank"> Download Now</a>
</p>
...
Orcest.ai & the community maintain a number of deployment methods, scripts, and templates that you can use to run Lamino locally. Refer to the table below to read how to deploy on your preferred environment or to automatically deploy.
...
_These are apps that are not maintained by Orcest.ai, but are compatible with Lamino. A listing here is not an endorsement._

- [Midori AI Subsystem Manager](https://io.midori-ai.xyz/subsystem/lamino/) - A streamlined and efficient way to deploy AI systems using Docker container technology.
- [Coolify](https://coolify.io/docs/services/lamino/) - Deploy Lamino with a single click.
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - A local Word Add-in for you to use Lamino in Microsoft Word.

## Telemetry & Privacy

Lamino by Orcest.ai contains a telemetry feature that collects anonymous usage information.
...
[View all telemetry events in source code](https://github.com/search?q=repo%3AOrcest-ai%2Flamino%20.sendTelemetry(&type=code)
...
[northflank-deploy]: https://northflank.com/stacks/deploy-lamino
